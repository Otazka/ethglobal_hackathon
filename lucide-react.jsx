...
// Simple icon components that match the Lucide React API
export const Wallet = ({ className = '', size = 24, ...props }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const Send = ({ className = '', size = 24, ...props }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const RefreshCw = ({ className = '', size = 24, ...props }) => (
  ...
  >
    ...
    <path d="M21 3v5h-5" />
    <path d="M21 12a9 9 0 0 1-9 9 9.75RM 9.75 0 0 1-6.74-2.74L3 16" />
    <path d="M3 21v-5h5" />
  </svg>
);
...
export const QrCode = ({ className = '', size = 24, ...props }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const Share = ({ className = '', size = 24, ...props }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const ArrowUpDown = ({ className = '', size = 24, ...props }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const History = ({ className = '', size = 24, ...props }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const UserPlus = ({ className = '', size = 24, ...props }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const ChevronDownIcon = ({ className = '', size = 24, ...props }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const ChevronUpIcon = ({ className = '', size = 24, ...props }) => (
  <svg
    className={className}
    width={size}
    height={size}
